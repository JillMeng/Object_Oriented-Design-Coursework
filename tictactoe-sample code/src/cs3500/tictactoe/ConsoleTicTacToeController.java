...
/**
 * Implementation of a TicTacToe controller that uses the console.
 */
public class ConsoleTicTacToeController implements TicTacToeController {
  ...
  /**
   * Constructor for a console-based controller.
   * 
   * @param in  the input
   * @param out the output
   * @param m   the model
   */
  public ConsoleTicTacToeController(Readable in, Appendable out, TicTacToe m) {
    if (in == null || out == null) {
